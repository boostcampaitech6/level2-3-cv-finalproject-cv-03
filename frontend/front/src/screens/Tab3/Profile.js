              ...
              <Block flex>
                ...
                <Overlay isVisible={passwordVisible} onBackdropPress={() => setPasswordVisible(false)}>
                  <View style={{ alignItems: 'center', justifyContent: 'center', padding: 40 }}>
                    ...
                    {fail && (
                      <Text style={styles.textError}  color={argonTheme.COLORS.ERROR}>비밀번호가 일치하지 않습니다.</Text>
                    )}
                  </View>
                </Overlay>
                <Overlay isVisible={password2Visible} onBackdropPress={() => setPassword2Visible(false)}>
                  <View style={{ alignItems: 'center', justifyContent: 'center', padding: 40 }}>
                    ...
                    {fail && (
                      <Text style={styles.textError}  color={argonTheme.COLORS.ERROR}>실패했습니다. {"("}네트워크 에러")</Text>
                    )}
                  </View>
                </Overlay>
