...
const Register = (props) => {
  ...
  const yakgwan = {
    ...
    "제2조": "정의",
    "내용1": "\"와치덕 앱 서비스\"는 CCTV 스트리밍을 통해 무인매장에서의 도난행위를 실시간으로 탐지하는 서비스를 의미합니다.",
    "내용2": "\"사용자\"는 와치덕 앱 서비스를 이용하는 개인 또는 단체를 말합니다.\n\n",
    
    "제3조": "서비스 이용",
    "내용1": "사용자는 와치덕 앱 서비스를 이용하기 위해 해당 앱을 설치해야 합니다.",
    "내용2": "서비스 이용 시, 사용자는 모든 관련 법규 및 약관을 준수해야 합니다.",
    "내용3": "사용자는 타인의 개인정보를 무단으로 수집하거나 악의적인 목적으로 사용해서는 안 됩니다.",
    
    "제4조": "서비스 제공 및 중단",
    "내용1": "와치덕 앱 서비스는 최상의 상태로 제공될 수 있도록 최선을 다하겠습니다.",
    "내용2": "기술적 문제나 상황 변화 등의 사유로 서비스가 중단될 수 있으며, 이에 따른 책임은 회사가 부담하지 않습니다.",
    
    "제5조": "책임 제한",
    "내용1": "와치덕 앱 서비스의 이용으로 발생한 일체의 손해에 대해 회사는 어떠한 책임도 부담하지 않습니다.",
  ...
  const yakgwan2 = {
    ...
    "제2조": "개인정보의 보유 및 이용기간",
    "내용1": "회사는 사용자의 개인정보를 서비스 제공 목적을 달성한 후 즉시 파기합니다.",
    "내용2": "다만, 관련 법령에 따라 보존할 필요가 있는 경우에는 해당 법령에서 정한 기간 동안 보관됩니다.",
    ...
    "내용2": "다만, 관련 법령에 따라 보존할 필요가 있는 경우에는 해당 법령에서 정한 방법에 따라 안전하게 파기됩니다.",
              ...
              <Block flex center>
                ...
                >
                  ...
                  <Overlay isVisible={overlayVisible} onBackdropPress={() => setOverlayVisible(false)}>
                    <View style={{ alignItems: '', justifyContent: 'center', padding: 30 }}>
                  ...
                  <Overlay isVisible={overlay2Visible} onBackdropPress={() => setOverlay2Visible(false)}>
                    <View style={{ alignItems: '', justifyContent: 'center', padding: 30 }}>
