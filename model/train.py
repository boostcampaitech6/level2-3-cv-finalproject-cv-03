...
for epoch in range(epochs):
        ...
        log_data.update(
            {
                ...
                f"train_{class_name}_precision": train_scores["precision"][i],
                f"train_{class_name}_recall": train_scores["recall"][i],
                f"valid_{class_name}_f1_score": valid_scores["f1"][i],
                f"valid_{class_name}_precision": valid_scores["precision"][i],
    ...
    wandb.sklearn.plot_confusion_matrix(
        train_scores["ture"], train_scores["pred"], labels=classes
    )
    wandb.sklearn.plot_confusion_matrix(
        valid_scores["ture"], valid_scores["pred"], labels=classes
    )
